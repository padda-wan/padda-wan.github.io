...
export default function Experience() {
  return (
    <Layout>
      <motion.h1 className="text-zinc-400" variants={itemVariants} initial="hidden" animate="visible">experience</motion.h1>
      <motion.div variants={containerVariants} initial="hidden" animate="visible">
        {
          experience.map((exp) => {
            ...
            return (
              <motion.div key={exp.company} className='mb-8 pl-5 border-l-2 border-gray-400' variants={itemVariants}>
